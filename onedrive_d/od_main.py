...
def main():
	...
	if args.log[0] == 'D': log_level = logging.DEBUG
	elif args.log[0] == 'I': log_level = logging.INFO
	elif args.log[0] == 'W': log_level = logging.WARNING
	elif args.log[0] == 'E': log_level = logging.ERROR
	else: log_level = logging.CRITICAL
